# Used by "source"ing this file and adding "$(git_prompt_string)" to your PROMPT or RPROMPT.
...
GIT_PROMPT_REBASE="%{$fg_bold[magenta]%}R%{$reset_color%}"
GIT_PROMPT_UNTRACKED="%{$fg_bold[red]%}U%{$reset_color%}"
GIT_PROMPT_MODIFIED="%{$fg_bold[cyan]%}*%{$reset_color%}"
